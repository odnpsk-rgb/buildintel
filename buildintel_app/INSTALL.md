...
- Если возникает ошибка "ModuleNotFoundError" - выполните `pip install -r requirements.txt`
...
Просто запустите `build_exe_advanced.bat`:
...
├── build_exe_advanced.bat  # Скрипт создания .exe файла
