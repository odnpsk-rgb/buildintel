...
- **Анализировать продающие тексты в строительстве** — получать структурированную маркетинговую аналитику с сильными/слабыми сторонами, уникальными предложениями и рекомендациями
- **Анализировать планировки квартир** — оценка удобства планировок, анализ расположения комнат, санузлов, лифтов, сильные и слабые стороны
